...
//=================================================================
  ...
  public boolean set ( int index, double element ) {
    ...
    else if( isEmpty() ) { return false; } // empty list cant change anything
  ...
  public int findLast ( double element ) {
    ...
    return result;  //Remove this when you implement the method!
  }
  ...
  public boolean inSort ( double elt ) {
    ...
    /*Your code here */
    Node current = new NodeImpl(elt, head);
    ...
    if (isEmpty()){
      ...
      return true;
       ...
       int counter = 0;
       while (elt > current.getNext().getValue()){
         current = current.getNext();
       ...
       if (elt<current.getNext().getValue()){
         ins(counter, elt);
         System.out.println(current.getValue());
         return true;
       }
